...
class Api {
  ...
  start () {
    ...
    // Sync key-value store — used by Apple Watch and multi-device coordination.
    // The hub acts as a relay: REST stores/retrieves keyed state, WS broadcasts live.
    // All keys return null when no data has been stored (e.g. no active live route).
